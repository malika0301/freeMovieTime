                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                ...
                                <div className="shrink-0">
                                    <Image
                                        ...
                                        alt={movie?.title_uz ?? 'Movie poster'}
                                        width={176}
                                        height={240}
